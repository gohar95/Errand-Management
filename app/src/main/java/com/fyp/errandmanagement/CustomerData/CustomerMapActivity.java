...
public class CustomerMapActivity<FusedLocationProviderClient> extends AppCompatActivity implements OnMapReadyCallback {
        ...
        if (list.size()>0)
        {
            ...
            conform_start_point.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Toast.makeText(CustomerMapActivity.this, fulladdress, Toast.LENGTH_SHORT).show();
                }
            });
