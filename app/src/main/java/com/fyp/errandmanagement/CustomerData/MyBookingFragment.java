...
import com.fyp.errandmanagement.Adapters.MyOrderAdapter;
...
public class MyBookingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemVIew =  inflater.inflate(R.layout.fragment_my_booking, container, false);

        recyclerView = itemVIew.findViewById(R.id.myorderRecyclerView);
    ...
    private void FetchData() {
        ...
        progressDialog.setTitle("Fetching Your Orders");
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot !=null){
                    for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                        ...
                        if(auth.getCurrentUser().getUid().equals(customerID)){
